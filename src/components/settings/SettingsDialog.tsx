        ...
        <div className="w-[368px] border border-[rgba(115,115,115,0.5)] rounded-[10px] p-[20px_15px] flex flex-col items-center">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 w-full mt-4">
            <div className="space-y-2">
              ...
              <Input placeholder="Coloque aqui o nome" className="border-[rgba(115,115,115,0.5)] rounded-md h-[35px] bg-transparent" {...register("name", {
            ...
            <div className="space-y-2">
              ...
              <Input placeholder="Coloque aqui no número com DDD" className="border-[rgba(115,115,115,0.5)] rounded-md h-[35px] bg-transparent" {...register("phone")} />
            </div>

            <div className="space-y-2">
              <label className="font-semibold text-[#737373]">Trocar e-mail</label>
              <Input placeholder="Coloque seu melhor e-mail" type="email" className="border-[rgba(115,115,115,0.5)] rounded-md h-[35px] bg-transparent" {...register("email", {
              pattern: {
                value: /^\S+@\S+$/i,
            ...
            <div className="space-y-2">
              ...
              <Input type="password" placeholder="Nova senha" className="border-[rgba(115,115,115,0.5)] rounded-md h-[35px] bg-transparent" {...register("password", {
              minLength: {
                value: 6,
            ...
            <div className="space-y-2">
              ...
              <Input type="password" placeholder="Confirme a nova senha" className="border-[rgba(115,115,115,0.5)] rounded-md h-[35px] bg-transparent" {...register("confirmPassword", {
              validate: value => {
            ...
            <Button type="submit" className="w-full bg-[#BFA76F] hover:bg-[#BFA76F]/90 text-[#EFEFEF] rounded-md py-3 font-bold">
              Salvar
            </Button>
          </form>
        </div>
