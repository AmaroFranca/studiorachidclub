...
const RewardsCarousel: React.FC = () => {
  ...
  if (loading) {
    return <div className="border border-[rgba(115,115,115,0.5)] rounded p-3 md:p-4 mb-4 md:mb-6 py-[10px] h-32 md:h-[180px] flex items-center justify-center">
        <p className="text-[#737373] text-sm md:text-base">Carregando recompensas...</p>
      </div>;
  }
  return <div className="border border-[rgba(115,115,115,0.5)] rounded p-3 md:p-4 mb-4 md:mb-6 h-32 md:h-[180px] overflow-hidden py-[13px]">
      <AnimatePresence mode="wait">
        ...
        duration: 0.5
          ...
          <img alt={currentItem?.name} className="w-24 h-24 md:w-28 md:h-28 lg:w-40 lg:h-40 object-cover rounded shadow-md flex-shrink-0" src={currentItem?.imageUrl} onError={handleImageError} />
