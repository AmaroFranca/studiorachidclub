...
const experiences: Experience[] = [{
  ...
  // Updated image path for Jantar Romântico
  points: 1200,
  remainingPoints: 930
}, {
  id: 2,
  ...
  // Updated image path for Day SPA
  points: 1500,
  ...
  // Updated image path for Sessão de Botox
  points: 1800,
  ...
  // Updated image path for Day Use Premium Casal
  points: 2000,
      ...
      <main className="flex-1 bg-[#EFEFEF] p-3 md:p-6">
        <div className="content-container my-[30px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-10">
            {experiences.map(experience => <ExperienceCard key={experience.id} name={experience.name} image={experience.image} points={experience.points} remainingPoints={experience.remainingPoints} />)}
          </div>
        </div>
      </main>
    </div>;
