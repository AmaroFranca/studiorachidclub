...
import { LayoutDashboard, Gift, Users, CircleDollarSign, List, Settings, MessageSquare, Heart, ArrowRight, Menu, LogOut } from "lucide-react";
            ...
            <div className="flex justify-between items-center mb-10">
              ...
              <div className="flex items-center gap-4">
                ...
                <DropdownMenu>
                  ...
                  >
                    <DropdownMenuItem className="flex items-center gap-2 text-[#737373] rounded-md px-[15px] hover:bg-[#B1C9C3] cursor-pointer">
                      <Settings className="text-[#BFA76F]" />
                      <span>Configurações</span>
                    </DropdownMenuItem>
                    <DropdownMenuItem className="flex items-center gap-2 text-[#737373] rounded-md px-[15px] hover:bg-[#B1C9C3] cursor-pointer">
