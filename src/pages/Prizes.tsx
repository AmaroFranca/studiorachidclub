      ...
      <main className="flex-1 bg-[#EFEFEF] p-3 md:p-6">
        <div className="content-container my-[30px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-10">
            {prizes.length > 0 ? prizes.map(prize => <PrizeCard key={prize.id} name={prize.name} image={prize.image_url} points={prize.points} userPoints={userPoints} />) : <div className="col-span-3 text-center py-10">
