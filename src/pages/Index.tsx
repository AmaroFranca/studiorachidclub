...
const Index: React.FC = () => {
  return (
    <div 
      className="max-w-none w-full h-screen flex items-center justify-center relative mx-auto max-md:max-w-[991px] max-md:p-5 max-sm:max-w-screen-sm max-sm:p-4 overflow-hidden"
      style={{ 
